...
import { removeCartItem } from '@/http/marketplace';
...
const RemoveCart: React.FC<RemoveCartProps> = ({ closeModal, productId }) => {
  const dispatch = useDispatch()
  const queryClient = useQueryClient();
  
  const { mutate: DeleteCartItem } = useAuthMutation(removeCartItem(productId), {
		onSuccess: (data) => {
