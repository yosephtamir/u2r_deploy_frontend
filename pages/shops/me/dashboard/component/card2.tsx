  ...
  return (
    <div className="rounded-md border border-stroke bg-brand-Light_Sky_Blue-shade90 py-6 px-7">
      <div className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-brand-Light_Sky_Blue-shade10">
        <svg className="fill-brand-Light_Sky_Blue-primary" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          ...
          <span className="text-sm --font-manropeL font-medium">Today’s revenue</span>
        </div>
