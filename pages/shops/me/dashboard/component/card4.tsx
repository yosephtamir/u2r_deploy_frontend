  ...
  return (
    <div className="rounded-md border border-stroke bg-brand-Light_Sky_Blue-shade90 py-6 px-7">
      <div className="flex h-[50px] w-[50px] items-center justify-center rounded-full bg-brand-Light_Sky_Blue-shade10">
        <svg className="fill-brand-Light_Sky_Blue-primary" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="mt-4 flex items-end justify-between">
        <div>
          ...
          <span className="text-sm --font-manropeL font-medium">Total Product</span>
        </div>

        <span className="flex items-center gap-1 text-md --font-manropeL text-brand-red-primary">
          0.35%
          <svg className="fill-brand-red-primary" width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
